...
package PGHandler;									# Define the package name
use CGI::Carp;
...
=item Parameters (Optional)
 ...
 DBSTAMP   => the name of the timestamp field within the table
              defaults to PGHandler Object Property <table>!PGHtimestamp
 ...
 MD5   	  => the name of the md5 encrypted field within the table
              defaults to PGHandler Object Property <table>!PGHmd5
...
=item  Parameters (required)
 ...
 KEY      => The table key to lookup in the database
               ...
               in the PGHkeyfld that has been set for the PGHandler object.
...
=item Example
 ...
 my $objPGDATA = new PGHandler::HTML ('mytable!PGHkeyfld' => 'id');
 my $lookupID = '01123';
